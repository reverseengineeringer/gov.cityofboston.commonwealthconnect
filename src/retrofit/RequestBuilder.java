  ...
  implements RequestInterceptor.RequestFacade
{
  ...
  RequestBuilder(String paramString, RestMethodInfo paramRestMethodInfo, Converter paramConverter)
  {
    ...
    paramAnnotations = requestParamAnnotations;
    ...
    paramString = requestQuery;
    if (paramString != null) {
      queryParams = new StringBuilder().append('?').append(paramString);
    }
    switch (requestType)
    {
    default: 
  ...
  private void addPathParam(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      relativeUrl = relativeUrl.replace("{" + paramString1 + "}", str);
      return;
    }
    ...
    relativeUrl = relativeUrl.replace("{" + paramString1 + "}", String.valueOf(paramString2));
  }
  ...
  public void addHeader(String paramString1, String paramString2)
  {
    ...
    {
      contentTypeHeader = paramString2;
      return;
    }
    ...
    throws UnsupportedEncodingException
  {
    ...
    Object localObject = apiUrl;
    StringBuilder localStringBuilder = new StringBuilder((String)localObject);
    if (((String)localObject).endsWith("/")) {
      localStringBuilder.deleteCharAt(localStringBuilder.length() - 1);
    }
    localStringBuilder.append(relativeUrl);
    localObject = queryParams;
    if (localObject != null) {
      localStringBuilder.append((CharSequence)localObject);
    }
    TypedOutput localTypedOutput = body;
    List localList2 = headers;
    ...
    if (contentTypeHeader != null)
    {
      ...
      localObject = new MimeOverridingTypedOutput(localTypedOutput, contentTypeHeader);
      localList1 = localList2;
    }
    for (;;)
    {
      return new Request(requestMethod, localStringBuilder.toString(), localList1, (TypedOutput)localObject);
      label154:
      localObject = new retrofit.client.Header("Content-Type", contentTypeHeader);
      if (localList2 == null)
      {
  ...
  void setArguments(Object[] paramArrayOfObject)
  {
    ...
    if (j < i)
    {
      ...
      localObject2 = paramAnnotations[j];
    ...
    for (;;)
    {
      ...
      else if (localObject3 == Field.class)
      {
        ...
        if (localObject1 != null) {
          if ((localObject1 instanceof Iterable))
          {
            ...
            while (((Iterator)localObject1).hasNext())
            {
              ...
              if (localObject3 != null) {
                formBody.addField((String)localObject2, localObject3.toString());
              }
            }
          }
          ...
          {
            formBody.addField((String)localObject2, localObject1.toString());
          }
        }
      }
      else if (localObject3 == FieldMap.class)
      {
        if (localObject1 != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if (localObject3 != null) {
              formBody.addField(localObject2.toString(), localObject3.toString());
            }
          }
        }
      }
      else if (localObject3 == Part.class)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if ((localObject1 instanceof TypedOutput)) {
            multipartBody.addPart((String)localObject3, (String)localObject2, (TypedOutput)localObject1);
          } else if ((localObject1 instanceof String)) {
            multipartBody.addPart((String)localObject3, (String)localObject2, new TypedString((String)localObject1));
          } else {
            multipartBody.addPart((String)localObject3, (String)localObject2, converter.toBody(localObject1));
          }
        }
      }
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if (localObject3 != null) {
              if ((localObject3 instanceof TypedOutput)) {
                multipartBody.addPart((String)localObject4, (String)localObject2, (TypedOutput)localObject3);
              } else if ((localObject3 instanceof String)) {
                multipartBody.addPart((String)localObject4, (String)localObject2, new TypedString((String)localObject3));
              } else {
                multipartBody.addPart((String)localObject4, (String)localObject2, converter.toBody(localObject3));
              }
            }
          }
        }
      ...
      else
      {
        ...
        if ((localObject1 instanceof TypedOutput)) {
          body = ((TypedOutput)localObject1);
        } else {
          body = converter.toBody(localObject1);
        }
      }
    }
    label1123:
