  ...
  implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, MenuItem.OnMenuItemClickListener
{
  ...
  private void installDecor()
  {
    ...
    for (;;)
    {
      ...
      break;
      label411:
      bool2 = mActivity.getTheme().obtainStyledAttributes(R.styleable.SherlockTheme).getBoolean(R.styleable.SherlockTheme_windowSplitActionBar, false);
      break label300;
      label436:
      if (bool2) {
      ...
      try
      {
        ...
        if (j != 1)
        {
          ...
          if (j == 2)
          {
            ...
            {
              j = i;
              if (!"uiOptions".equals(localXmlResourceParser.getAttributeName(m))) {
                break label354;
              }
              j = i;
              k = localXmlResourceParser.getAttributeIntValue(m, 0);
            }
          }
          j = k;
  ...
  public ActionMode startActionMode(ActionMode.Callback paramCallback)
  {
    ...
    initActionBar();
    if (aActionBar != null) {
      localObject = aActionBar.startActionMode(localActionModeCallbackWrapper);
    }
    if (localObject != null) {
