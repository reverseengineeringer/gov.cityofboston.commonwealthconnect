...
public class GetPlacesVolleyTask
{
  ...
  public GetPlacesVolleyTask(Context paramContext, int paramInt, Response.Listener<JSONObject> paramListener, Response.ErrorListener paramErrorListener)
  {
    c = paramContext;
    userId = paramInt;
  ...
  public GetPlacesVolleyTask(Context paramContext, int paramInt, Response.Listener<JSONObject> paramListener, Response.ErrorListener paramErrorListener, AuthUser paramAuthUser)
  {
    c = paramContext;
    userId = paramInt;
...
/* Location:
 * Qualified Name:     com.seeclickfix.ma.android.tasks.GetPlacesVolleyTask
