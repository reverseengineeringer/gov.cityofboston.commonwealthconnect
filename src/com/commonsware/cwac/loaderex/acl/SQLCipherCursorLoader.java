  ...
  extends AbstractCursorLoader
{
  ...
  public SQLCipherCursorLoader(Context paramContext, SQLiteDatabase paramSQLiteDatabase, String paramString, String[] paramArrayOfString)
  {
    super(paramContext);
...
/* Location:
 * Qualified Name:     com.commonsware.cwac.loaderex.acl.SQLCipherCursorLoader
