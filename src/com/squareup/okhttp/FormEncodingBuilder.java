...
public final class FormEncodingBuilder
{
  ...
  public FormEncodingBuilder add(String paramString1, String paramString2)
  {
    ...
    try
    {
      content.append(URLEncoder.encode(paramString1, "UTF-8")).append('=').append(URLEncoder.encode(paramString2, "UTF-8"));
      return this;
    }
  ...
  public RequestBody build()
  {
    ...
    byte[] arrayOfByte = content.toString().getBytes(Util.UTF_8);
