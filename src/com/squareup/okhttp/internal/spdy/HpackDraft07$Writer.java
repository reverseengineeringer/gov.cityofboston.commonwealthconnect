...
final class HpackDraft07$Writer
{
  private final Buffer out;
  
  HpackDraft07$Writer(Buffer paramBuffer)
  {
    out = paramBuffer;
  }
    ...
    throws IOException
  {
    ...
    if (i < j)
    {
      ...
      Integer localInteger = (Integer)HpackDraft07.access$200().get(localByteString);
...
/* Location:
 * Qualified Name:     com.squareup.okhttp.internal.spdy.HpackDraft07.Writer
