  ...
  implements Variant
{
    ...
    implements Source
  {
      ...
      throws IOException
    {
      ...
      if (Http20Draft12.logger.isLoggable(Level.FINE)) {
        Http20Draft12.logger.fine(Http20Draft12.FrameLogger.formatHeader(true, streamId, length, b, flags));
      }
      padding = Http20Draft12.readPadding(source, flags);
      short s = Http20Draft12.lengthWithoutPadding(length, flags, padding);
      left = s;
      length = s;
    ...
    implements FrameReader
  {
      ...
      throws IOException
    {
      ...
      label46:
      short s = Http20Draft12.readPadding(source, paramByte);
      ...
      throws IOException
    {
      ...
      {
        short s2 = Http20Draft12.readPadding(source, paramByte);
        short s1 = paramShort;
        if ((paramByte & 0x20) != 0)
        {
      ...
      throws IOException
    {
      ...
      {
        return;
        localByteString = source.readByteString(Http20Draft12.CONNECTION_PREFACE.size());
        if (Http20Draft12.logger.isLoggable(Level.FINE)) {
    ...
    implements FrameWriter
  {
      ...
      throws IOException
    {
      ...
      for (;;)
      {
        ...
        sink.write(Http20Draft12.CONNECTION_PREFACE.toByteArray());
        sink.flush();
      }
    }
