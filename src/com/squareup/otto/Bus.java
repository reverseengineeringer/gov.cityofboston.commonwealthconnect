...
public class Bus
{
  ...
  protected void dispatchQueuedEvents()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 68	com/squareup/otto/Bus:isDispatching	Ljava/lang/ThreadLocal;
    ...
    //   16: return
    //   17: aload_0
    //   18: getfield 68	com/squareup/otto/Bus:isDispatching	Ljava/lang/ThreadLocal;
    //   21: iconst_1
    ...
    //   28: aload_0
    //   29: getfield 65	com/squareup/otto/Bus:eventsToDispatch	Ljava/lang/ThreadLocal;
    ...
    //   46: ifnonnull +15 -> 61
    //   49: aload_0
    //   50: getfield 68	com/squareup/otto/Bus:isDispatching	Ljava/lang/ThreadLocal;
    //   53: iconst_0
    ...
    //   60: return
    //   61: aload_1
    //   62: getfield 203	com/squareup/otto/Bus$EventWithHandler:handler	Lcom/squareup/otto/EventHandler;
    //   65: invokevirtual 206	com/squareup/otto/EventHandler:isValid	()Z
    //   68: ifeq -40 -> 28
    //   71: aload_0
    //   72: aload_1
    //   73: getfield 210	com/squareup/otto/Bus$EventWithHandler:event	Ljava/lang/Object;
    //   76: aload_1
    //   77: getfield 203	com/squareup/otto/Bus$EventWithHandler:handler	Lcom/squareup/otto/EventHandler;
    //   80: invokevirtual 120	com/squareup/otto/Bus:dispatch	(Ljava/lang/Object;Lcom/squareup/otto/EventHandler;)V
    //   83: goto -55 -> 28
    //   86: astore_1
    //   87: aload_0
    //   88: getfield 68	com/squareup/otto/Bus:isDispatching	Ljava/lang/ThreadLocal;
    //   91: iconst_0
    //   92: invokestatic 191	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   95: invokevirtual 194	java/lang/ThreadLocal:set	(Ljava/lang/Object;)V
    //   98: aload_1
    //   99: athrow
  ...
  {
    Set localSet2 = (Set)flattenHierarchyCache.get(paramClass);
    Set localSet1 = localSet2;
    if (localSet2 == null)
    {
      localSet1 = getClassesFor(paramClass);
      flattenHierarchyCache.put(paramClass, localSet1);
    }
    return localSet1;
  }
