...
public class ByteArrayPool
{
  ...
  private void trim()
  {
    ...
    //   6: aload_0
    //   7: getfield 41	com/android/volley/toolbox/ByteArrayPool:mSizeLimit	I
    //   10: if_icmple +47 -> 57
    //   13: aload_0
    //   14: getfield 31	com/android/volley/toolbox/ByteArrayPool:mBuffersByLastUse	Ljava/util/List;
    //   17: iconst_0
    //   18: invokeinterface 48 2 0
    //   23: checkcast 50	[B
    //   26: astore_1
    //   27: aload_0
    //   28: getfield 37	com/android/volley/toolbox/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   31: aload_1
    //   32: invokeinterface 53 2 0
    //   37: pop
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 39	com/android/volley/toolbox/ByteArrayPool:mCurrentSize	I
    //   43: aload_1
    //   44: arraylength
    //   45: isub
    //   46: putfield 39	com/android/volley/toolbox/ByteArrayPool:mCurrentSize	I
    //   49: goto -47 -> 2
    //   52: astore_1
    //   53: aload_0
    //   54: monitorexit
  ...
  public byte[] getBuf(int paramInt)
  {
    ...
    //   4: iload_2
    //   5: aload_0
    //   6: getfield 37	com/android/volley/toolbox/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   9: invokeinterface 59 1 0
    //   14: if_icmpge +67 -> 81
    //   17: aload_0
    //   18: getfield 37	com/android/volley/toolbox/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   21: iload_2
    ...
    //   37: aload_0
    //   38: aload_0
    //   39: getfield 39	com/android/volley/toolbox/ByteArrayPool:mCurrentSize	I
    //   42: aload_3
    //   43: arraylength
    //   44: isub
    //   45: putfield 39	com/android/volley/toolbox/ByteArrayPool:mCurrentSize	I
    //   48: aload_0
    //   49: getfield 37	com/android/volley/toolbox/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   52: iload_2
    //   53: invokeinterface 48 2 0
    //   58: pop
    //   59: aload_0
    //   60: getfield 31	com/android/volley/toolbox/ByteArrayPool:mBuffersByLastUse	Ljava/util/List;
    //   63: aload_3
