  ...
  implements ScheduledExecutorService
{
  ...
  {
    return delegate.scheduleAtFixedRate(wrapTask(paramRunnable), paramLong1, paramLong2, paramTimeUnit);
  }
  ...
  {
    return delegate.scheduleWithFixedDelay(wrapTask(paramRunnable), paramLong1, paramLong2, paramTimeUnit);
  }
}
