  ...
  implements Executor
{
  ...
  public void execute(Runnable arg1)
  {
    ...
    //   0: aload_1
    //   1: ldc 88
    //   3: invokestatic 72	com/google/common/base/Preconditions:checkNotNull	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   6: pop
    //   7: iconst_0
    //   8: istore_2
    //   9: aload_0
    //   10: getfield 64	com/google/common/util/concurrent/SerializingExecutor:internalLock	Ljava/lang/Object;
    //   13: astore_3
    //   14: aload_3
    //   15: monitorenter
    //   16: aload_0
    //   17: getfield 52	com/google/common/util/concurrent/SerializingExecutor:waitQueue	Ljava/util/Queue;
    //   20: aload_1
    //   21: invokeinterface 94 2 0
    //   26: pop
    //   27: aload_0
    //   28: getfield 54	com/google/common/util/concurrent/SerializingExecutor:isThreadScheduled	Z
    //   31: ifne +10 -> 41
    //   34: aload_0
    //   35: iconst_1
    //   36: putfield 54	com/google/common/util/concurrent/SerializingExecutor:isThreadScheduled	Z
    //   39: iconst_1
    //   40: istore_2
    //   41: aload_3
    //   42: monitorexit
    ...
    //   44: ifeq +34 -> 78
    //   47: aload_0
    //   48: getfield 74	com/google/common/util/concurrent/SerializingExecutor:executor	Ljava/util/concurrent/Executor;
    //   51: aload_0
    //   52: getfield 59	com/google/common/util/concurrent/SerializingExecutor:taskRunner	Lcom/google/common/util/concurrent/SerializingExecutor$TaskRunner;
    //   55: invokeinterface 96 2 0
    //   60: iconst_0
    //   61: ifeq +17 -> 78
    //   64: aload_0
    //   65: getfield 64	com/google/common/util/concurrent/SerializingExecutor:internalLock	Ljava/lang/Object;
    //   68: astore_1
    //   69: aload_1
    //   70: monitorenter
    //   71: aload_0
    //   72: iconst_0
    //   73: putfield 54	com/google/common/util/concurrent/SerializingExecutor:isThreadScheduled	Z
    //   76: aload_1
    //   77: monitorexit
    //   78: return
    //   79: astore_1
    ...
    //   91: ifeq +17 -> 108
    //   94: aload_0
    //   95: getfield 64	com/google/common/util/concurrent/SerializingExecutor:internalLock	Ljava/lang/Object;
    //   98: astore_1
    //   99: aload_1
    //   100: monitorenter
    //   101: aload_0
    //   102: iconst_0
    //   103: putfield 54	com/google/common/util/concurrent/SerializingExecutor:isThreadScheduled	Z
    //   106: aload_1
    //   107: monitorexit
    //   108: aload_3
    //   109: athrow
