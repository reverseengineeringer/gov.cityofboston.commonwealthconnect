  ...
  implements TimeLimiter
{
  ...
  {
    executor = ((ExecutorService)Preconditions.checkNotNull(paramExecutorService));
  }
    ...
    throws Exception
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramCallable = executor.submit(paramCallable);
      if (!paramBoolean) {
        break;
      }
      try
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      (T)newProxy(paramClass, new InvocationHandler()
      {
          ...
          throws Throwable
        {
          ...
          return callWithTimeout((Callable)paramAnonymousObject, paramLong, val$timeoutUnit, val$interruptibleMethods.contains(paramAnonymousMethod));
        }
      });
    }
  }
