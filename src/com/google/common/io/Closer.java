  ...
  implements Closeable
{
  ...
  {
    suppressor = ((Suppressor)Preconditions.checkNotNull(paramSuppressor));
  }
  ...
  public void close()
    throws IOException
  {
    Object localObject = thrown;
    while (!stack.isEmpty())
    {
      Closeable localCloseable = (Closeable)stack.removeFirst();
      try
      {
      ...
      catch (Throwable localThrowable)
      {
        if (localObject == null) {
          ...
          suppressor.suppress(localCloseable, (Throwable)localObject, localThrowable);
        }
      }
    }
    if ((thrown == null) && (localObject != null))
    {
