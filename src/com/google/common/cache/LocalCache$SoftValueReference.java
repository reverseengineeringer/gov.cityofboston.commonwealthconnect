  ...
  implements LocalCache.ValueReference<K, V>
{
  ...
  LocalCache$SoftValueReference(ReferenceQueue<V> paramReferenceQueue, V paramV, LocalCache.ReferenceEntry<K, V> paramReferenceEntry)
  {
...
/* Location:
 * Qualified Name:     com.google.common.cache.LocalCache.SoftValueReference
