  ...
  public static final class TeredoInfo
  {
    ...
    public TeredoInfo(@Nullable Inet4Address paramInet4Address1, @Nullable Inet4Address paramInet4Address2, int paramInt1, int paramInt2)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        server = ((Inet4Address)Objects.firstNonNull(paramInet4Address1, InetAddresses.ANY4));
        client = ((Inet4Address)Objects.firstNonNull(paramInet4Address2, InetAddresses.ANY4));
        port = paramInt1;
        flags = paramInt2;
        return;
        bool = false;
