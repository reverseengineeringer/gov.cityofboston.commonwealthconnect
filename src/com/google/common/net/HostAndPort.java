  ...
  implements Serializable
{
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    } while ((Objects.equal(host, host)) && (port == port) && (hasBracketlessColons == hasBracketlessColons));
    return false;
    return false;
  }
  ...
  public HostAndPort requireBracketsForIPv6()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      Preconditions.checkArgument(bool, "Possible bracketless IPv6 literal: %s", new Object[] { host });
      return this;
    }
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(host.length() + 8);
    if (host.indexOf(':') >= 0) {
