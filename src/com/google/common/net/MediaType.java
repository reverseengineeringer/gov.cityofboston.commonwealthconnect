...
public final class MediaType
{
  ...
  {
    Maps.transformValues(parameters.asMap(), new Function()
    {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    } while ((type.equals(type)) && (subtype.equals(subtype)) && (parametersAsMap().equals(((MediaType)paramObject).parametersAsMap())));
    return false;
    return false;
  }
  ...
  public int hashCode()
  {
    return Objects.hashCode(new Object[] { type, subtype, parametersAsMap() });
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder().append(type).append('/').append(subtype);
    if (!parameters.isEmpty())
    {
      localStringBuilder.append("; ");
      ListMultimap localListMultimap = Multimaps.transformValues(parameters, new Function()
      {
  ...
  public MediaType withParameter(String paramString1, String paramString2)
  {
    ...
    paramString1 = new MediaType(type, subtype, localBuilder.build());
    return (MediaType)Objects.firstNonNull(KNOWN_TYPES.get(paramString1), paramString1);
  }
