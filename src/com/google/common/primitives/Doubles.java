...
public final class Doubles
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Double)) && (Doubles.indexOf(array, ((Double)paramObject).doubleValue(), start, end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Doubles.indexOf(array, ((Double)paramObject).doubleValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Double))
      {
        int i = Doubles.lastIndexOf(array, ((Double)paramObject).doubleValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
