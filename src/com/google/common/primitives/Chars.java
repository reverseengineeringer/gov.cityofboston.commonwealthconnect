...
public final class Chars
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Character)) && (Chars.indexOf(array, ((Character)paramObject).charValue(), start, end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Chars.indexOf(array, ((Character)paramObject).charValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Character))
      {
        int i = Chars.lastIndexOf(array, ((Character)paramObject).charValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
