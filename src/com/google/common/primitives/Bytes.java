...
public final class Bytes
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Byte)) && (Bytes.indexOf(array, ((Byte)paramObject).byteValue(), start, end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Bytes.indexOf(array, ((Byte)paramObject).byteValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Byte))
      {
        int i = Bytes.lastIndexOf(array, ((Byte)paramObject).byteValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
