...
public final class Shorts
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Short)) && (Shorts.indexOf(array, ((Short)paramObject).shortValue(), start, end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Shorts.indexOf(array, ((Short)paramObject).shortValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Short))
      {
        int i = Shorts.lastIndexOf(array, ((Short)paramObject).shortValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
