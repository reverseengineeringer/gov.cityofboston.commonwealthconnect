...
public final class Floats
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Float)) && (Floats.indexOf(array, ((Float)paramObject).floatValue(), start, end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Floats.indexOf(array, ((Float)paramObject).floatValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Float))
      {
        int i = Floats.lastIndexOf(array, ((Float)paramObject).floatValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
