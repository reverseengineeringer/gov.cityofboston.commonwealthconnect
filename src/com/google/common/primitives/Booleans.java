...
public final class Booleans
{
    ...
    implements RandomAccess, Serializable
  {
    ...
    {
      return ((paramObject instanceof Boolean)) && (Booleans.indexOf(array, ((Boolean)paramObject).booleanValue(), start, end) != -1);
    }
    ...
    public int indexOf(Object paramObject)
    {
      ...
      {
        int i = Booleans.indexOf(array, ((Boolean)paramObject).booleanValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
    ...
    public int lastIndexOf(Object paramObject)
    {
      if ((paramObject instanceof Boolean))
      {
        int i = Booleans.lastIndexOf(array, ((Boolean)paramObject).booleanValue(), start, end);
        if (i >= 0) {
          return i - start;
        }
      }
