  ...
  implements Serializable
{
  ...
  private GeneralRange(Comparator<? super T> paramComparator, boolean paramBoolean1, @Nullable T paramT1, BoundType paramBoundType1, boolean paramBoolean2, @Nullable T paramT2, BoundType paramBoundType2)
  {
    ...
    lowerEndpoint = paramT1;
    lowerBoundType = ((BoundType)Preconditions.checkNotNull(paramBoundType1));
    upperEndpoint = paramT2;
    upperBoundType = ((BoundType)Preconditions.checkNotNull(paramBoundType2));
    if (paramBoolean1) {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    ...
    if ((paramObject instanceof GeneralRange))
    {
      ...
      if (comparator.equals(comparator))
      {
        ...
        {
          bool1 = bool2;
          if (hasUpperBound == hasUpperBound)
          {
            bool1 = bool2;
  ...
  public int hashCode()
  {
    return Objects.hashCode(new Object[] { comparator, getLowerEndpoint(), getLowerBoundType(), getUpperEndpoint(), getUpperBoundType() });
  }
  ...
  GeneralRange<T> intersect(GeneralRange<T> paramGeneralRange)
  {
    ...
    for (;;)
    {
      ...
      return new GeneralRange(comparator, bool1, localObject6, (BoundType)localObject5, bool2, localObject3, paramGeneralRange);
      bool1 = bool2;
      ...
      int i = comparator.compare(getLowerEndpoint(), paramGeneralRange.getLowerEndpoint());
      if (i >= 0)
      {
        bool1 = bool2;
        localObject1 = localObject3;
  ...
  {
    GeneralRange localGeneralRange = reverse;
    if (localGeneralRange == null)
    {
      localGeneralRange = new GeneralRange(Ordering.from(comparator).reverse(), hasUpperBound, getUpperEndpoint(), getUpperBoundType(), hasLowerBound, getLowerEndpoint(), getLowerBoundType());
      reverse = this;
      reverse = localGeneralRange;
  ...
  {
    Object localObject = new StringBuilder().append(comparator).append(":");
  ...
  boolean tooHigh(@Nullable T paramT)
  {
    ...
    int j = comparator.compare(paramT, localObject);
    int i;
    if (j > 0)
    {
      i = 1;
