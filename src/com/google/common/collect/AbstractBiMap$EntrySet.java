  ...
  extends ForwardingSet<Map.Entry<K, V>>
{
    ...
    new Iterator()
    {
        ...
        new ForwardingMapEntry()
        {
          ...
          public V setValue(V paramAnonymous2V)
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              AbstractBiMap.access$600(this$0, getKey(), true, localObject, paramAnonymous2V);
      ...
      public void remove()
      {
        ...
        for (boolean bool = true;; bool = false)
        {
          ...
          val$iterator.remove();
          AbstractBiMap.access$700(this$0, localObject);
          return;
        }
      }
    };
  ...
  public boolean remove(Object paramObject)
  {
    ...
    AbstractBiMap.access$200(this$0.inverse).remove(((Map.Entry)paramObject).getValue());
