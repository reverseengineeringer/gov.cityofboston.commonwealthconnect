  ...
  implements MapMakerInternalMap.ReferenceEntry<K, V>
{
  ...
  MapMakerInternalMap$WeakEntry(ReferenceQueue<K> paramReferenceQueue, K paramK, int paramInt, @Nullable MapMakerInternalMap.ReferenceEntry<K, V> paramReferenceEntry)
  {
