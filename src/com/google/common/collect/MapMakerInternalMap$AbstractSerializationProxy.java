  ...
  implements Serializable
{
    ...
    throws IOException
  {
    ...
    paramObjectInputStream = new MapMaker().initialCapacity(i).setKeyStrength(keyStrength).setValueStrength(valueStrength).keyEquivalence(keyEquivalence).concurrencyLevel(concurrencyLevel);
