  ...
  extends ReentrantLock
{
  ...
  void expand()
  {
    ...
    if (j < i1)
    {
      ...
      localReferenceEntry2 = copyEntry(localReferenceEntry1, (MapMakerInternalMap.ReferenceEntry)localAtomicReferenceArray2.get(k));
      if (localReferenceEntry2 != null) {
        localAtomicReferenceArray2.set(k, localReferenceEntry2);
      }
      for (;;)
  ...
  V get(Object paramObject, int paramInt)
  {
    ...
    //   1: aload_1
    //   2: iload_2
    //   3: invokevirtual 212	com/google/common/collect/MapMakerInternalMap$Segment:getLiveEntry	(Ljava/lang/Object;I)Lcom/google/common/collect/MapMakerInternalMap$ReferenceEntry;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnonnull +9 -> 17
    //   11: aload_0
    //   12: invokevirtual 215	com/google/common/collect/MapMakerInternalMap$Segment:postReadCleanup	()V
    //   15: aconst_null
    //   16: areturn
    //   17: aload_1
    //   18: invokeinterface 131 1 0
    //   23: invokeinterface 217 1 0
    //   28: astore_3
    //   29: aload_3
    //   30: ifnull +14 -> 44
    //   33: aload_0
    //   34: aload_1
    //   35: invokevirtual 338	com/google/common/collect/MapMakerInternalMap$Segment:recordRead	(Lcom/google/common/collect/MapMakerInternalMap$ReferenceEntry;)V
    //   38: aload_0
    //   39: invokevirtual 215	com/google/common/collect/MapMakerInternalMap$Segment:postReadCleanup	()V
    //   42: aload_3
    //   43: areturn
    //   44: aload_0
    //   45: invokevirtual 341	com/google/common/collect/MapMakerInternalMap$Segment:tryDrainReferenceQueues	()V
    //   48: goto -10 -> 38
    //   51: astore_1
    //   52: aload_0
    //   53: invokevirtual 215	com/google/common/collect/MapMakerInternalMap$Segment:postReadCleanup	()V
    //   56: aload_1
    //   57: athrow
  ...
  MapMakerInternalMap.ReferenceEntry<K, V> removeFromChain(MapMakerInternalMap.ReferenceEntry<K, V> paramReferenceEntry1, MapMakerInternalMap.ReferenceEntry<K, V> paramReferenceEntry2)
  {
    ...
    {
      MapMakerInternalMap.ReferenceEntry localReferenceEntry = copyEntry(paramReferenceEntry1, (MapMakerInternalMap.ReferenceEntry)localObject);
      if (localReferenceEntry != null) {
    ...
    count = i;
    return (MapMakerInternalMap.ReferenceEntry<K, V>)localObject;
  }
