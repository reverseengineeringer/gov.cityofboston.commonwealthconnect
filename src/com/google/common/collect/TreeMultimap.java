  ...
  extends AbstractSortedKeySortedSetMultimap<K, V>
{
  ...
  TreeMultimap(Comparator<? super K> paramComparator, Comparator<? super V> paramComparator1)
  {
    ...
    valueComparator = paramComparator1;
  }
    ...
    throws IOException, ClassNotFoundException
  {
    ...
    keyComparator = ((Comparator)Preconditions.checkNotNull((Comparator)paramObjectInputStream.readObject()));
    valueComparator = ((Comparator)Preconditions.checkNotNull((Comparator)paramObjectInputStream.readObject()));
