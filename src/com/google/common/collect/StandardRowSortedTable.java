  ...
  implements RowSortedTable<R, C, V>
{
    ...
    implements SortedMap<R, Map<C, V>>
  {
    ...
    public SortedMap<R, Map<C, V>> headMap(R paramR)
    {
      ...
      return new StandardRowSortedTable(StandardRowSortedTable.this.sortedBackingMap().headMap(paramR), factory).rowMap();
    }
    ...
    public SortedMap<R, Map<C, V>> subMap(R paramR1, R paramR2)
    {
      ...
      return new StandardRowSortedTable(StandardRowSortedTable.this.sortedBackingMap().subMap(paramR1, paramR2), factory).rowMap();
    }
    
    public SortedMap<R, Map<C, V>> tailMap(R paramR)
    {
      Preconditions.checkNotNull(paramR);
      return new StandardRowSortedTable(StandardRowSortedTable.this.sortedBackingMap().tailMap(paramR), factory).rowMap();
    }
  }
}
