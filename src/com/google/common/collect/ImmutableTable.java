  ...
  extends AbstractTable<R, C, V>
{
  ...
  public ImmutableMap<R, V> column(C paramC)
  {
    ...
    return (ImmutableMap)Objects.firstNonNull((ImmutableMap)columnMap().get(paramC), ImmutableMap.of());
  }
  ...
  public ImmutableMap<C, V> row(R paramR)
  {
    ...
    return (ImmutableMap)Objects.firstNonNull((ImmutableMap)rowMap().get(paramR), ImmutableMap.of());
  }
