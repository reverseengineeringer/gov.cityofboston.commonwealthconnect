  ...
  implements ju
{
    ...
    throws RemoteException
  {
    ...
    paramParcel1 = a(d.a.ap(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
    ...
    implements ju
  {
      ...
      throws RemoteException
    {
      ...
      //   46: aload_0
      //   47: getfield 18	com/google/android/gms/internal/ju$a$a:le	Landroid/os/IBinder;
      //   50: iconst_1
      //   51: aload 4
      //   53: aload 5
      //   55: iconst_0
      ...
      //   72: invokestatic 65	com/google/android/gms/dynamic/d$a:ap	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/d;
      //   75: astore_1
      //   76: aload 5
