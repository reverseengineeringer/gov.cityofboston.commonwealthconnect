  ...
  implements IStreetViewPanoramaDelegate
{
    ...
    throws RemoteException
  {
    ...
    case 9: 
      paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
      if (paramParcel1.readInt() != 0) {}
      for (localObject1 = StreetViewPanoramaCamera.CREATOR.di(paramParcel1);; localObject1 = null)
      {
    ...
    case 18: 
      paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
      paramParcel1 = pointToOrientation(d.a.ap(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      if (paramParcel1 != null)
      {
        paramParcel2.writeInt(1);
    ...
    implements IStreetViewPanoramaDelegate
  {
      ...
      throws RemoteException
    {
      ...
      //   40: aload_0
      //   41: getfield 18	com/google/android/gms/maps/internal/IStreetViewPanoramaDelegate$a$a:le	Landroid/os/IBinder;
      //   44: bipush 9
      //   46: aload 4
      //   48: aload 5
      //   50: iconst_0
      ...
      throws RemoteException
    {
      ...
      //   26: aload_0
      //   27: getfield 18	com/google/android/gms/maps/internal/IStreetViewPanoramaDelegate$a$a:le	Landroid/os/IBinder;
      //   30: iconst_1
      //   31: aload_3
      //   32: aload 4
      //   34: iconst_0
      ...
      throws RemoteException
    {
      ...
      //   14: aload_0
      //   15: getfield 18	com/google/android/gms/maps/internal/IStreetViewPanoramaDelegate$a$a:le	Landroid/os/IBinder;
      //   18: bipush 10
      //   20: aload_2
      //   21: aload_3
      //   22: iconst_0
      ...
      //   43: aload_3
      //   44: invokevirtual 85	com/google/android/gms/maps/model/q:di	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/StreetViewPanoramaCamera;
      //   47: astore_1
      //   48: aload_3
      ...
      throws RemoteException
    {
      ...
      //   43: aload_3
      //   44: invokevirtual 98	com/google/android/gms/maps/model/s:dk	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/StreetViewPanoramaLocation;
      //   47: astore_1
      //   48: aload_3
      //   49: invokevirtual 61	android/os/Parcel:recycle	()V
      //   52: aload_2
      ...
      throws RemoteException
    {
      ...
      //   29: aload_0
      //   30: getfield 18	com/google/android/gms/maps/internal/IStreetViewPanoramaDelegate$a$a:le	Landroid/os/IBinder;
      //   33: bipush 19
      //   35: aload_2
      //   36: aload_3
      //   37: iconst_0
      ...
      //   52: invokestatic 117	com/google/android/gms/dynamic/d$a:ap	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/d;
      //   55: astore_1
      //   56: aload_3
      ...
      throws RemoteException
    {
      ...
      //   33: aload_0
      //   34: getfield 18	com/google/android/gms/maps/internal/IStreetViewPanoramaDelegate$a$a:le	Landroid/os/IBinder;
      //   37: bipush 18
      //   39: aload_3
      //   40: aload 4
      //   42: iconst_0
      ...
      //   67: aload 4
      //   69: invokevirtual 135	com/google/android/gms/maps/model/t:dl	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/StreetViewPanoramaOrientation;
      //   72: astore_1
      //   73: aload 4
      ...
      throws RemoteException
    {
      ...
      //   30: aload_0
      //   31: getfield 18	com/google/android/gms/maps/internal/IStreetViewPanoramaDelegate$a$a:le	Landroid/os/IBinder;
      //   34: bipush 16
      //   36: aload_2
      //   37: aload_3
      //   38: iconst_0
      ...
      throws RemoteException
    {
      ...
      //   35: aload_0
      //   36: getfield 18	com/google/android/gms/maps/internal/IStreetViewPanoramaDelegate$a$a:le	Landroid/os/IBinder;
      //   39: bipush 13
      //   41: aload_3
      //   42: aload 4
      //   44: iconst_0
