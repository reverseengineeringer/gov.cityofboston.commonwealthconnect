  ...
  implements ICameraUpdateFactoryDelegate
{
    ...
    implements ICameraUpdateFactoryDelegate
  {
      ...
      throws RemoteException
    {
      ...
      //   29: aload_0
      //   30: getfield 18	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:le	Landroid/os/IBinder;
      //   33: bipush 7
      //   35: aload_2
      //   36: aload_3
      //   37: iconst_0
      ...
      throws RemoteException
    {
      ...
      //   35: aload_0
      //   36: getfield 18	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:le	Landroid/os/IBinder;
      //   39: bipush 10
      //   41: aload_3
      //   42: aload 4
      //   44: iconst_0
      ...
      //   61: invokestatic 65	com/google/android/gms/dynamic/d$a:ap	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/d;
      //   64: astore_1
      //   65: aload 4
      ...
      throws RemoteException
    {
      ...
      //   53: aload_0
      //   54: getfield 18	com/google/android/gms/maps/internal/ICameraUpdateFactoryDelegate$a$a:le	Landroid/os/IBinder;
      //   57: bipush 11
      //   59: aload 5
      //   61: aload 6
      //   63: iconst_0
      ...
      //   80: invokestatic 65	com/google/android/gms/dynamic/d$a:ap	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/d;
      //   83: astore_1
      //   84: aload 6
