  ...
  extends aj
{
  ...
  private e zc = new e()
  {
    ...
    {
      a(paramAnonymousBoolean, v.a(v.this));
    }
  };
  private u zd;
      ...
      public boolean handleMessage(Message paramAnonymousMessage)
      {
        if ((1 == what) && (v.ez().equals(obj)))
        {
          ...
          if ((v.b(v.this) > 0) && (!v.c(v.this))) {
            v.d(v.this).sendMessageDelayed(v.d(v.this).obtainMessage(1, v.ez()), v.b(v.this) * 1000);
          }
        }
        return true;
      }
  ...
  void a(Context paramContext, f paramf)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 87	com/google/android/gms/analytics/v:mContext	Landroid/content/Context;
    //   6: astore_3
    //   7: aload_3
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   19: putfield 87	com/google/android/gms/analytics/v:mContext	Landroid/content/Context;
    //   22: aload_0
    ...
    //   34: aload_0
    //   35: getfield 50	com/google/android/gms/analytics/v:yX	Z
    //   38: ifeq +12 -> 50
    //   41: aload_0
    //   42: invokevirtual 129	com/google/android/gms/analytics/v:dispatchLocalHits	()V
    //   45: aload_0
    //   46: iconst_0
    //   47: putfield 50	com/google/android/gms/analytics/v:yX	Z
    //   50: aload_0
  ...
  void dispatchLocalHits()
  {
    ...
    //   14: aload_0
    //   15: iconst_1
    //   16: putfield 50	com/google/android/gms/analytics/v:yX	Z
    //   19: aload_0
    //   20: monitorexit
    //   21: return
  ...
  void setLocalDispatchPeriod(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 72	com/google/android/gms/analytics/v:mHandler	Landroid/os/Handler;
    //   6: ifnonnull +16 -> 22
    //   9: ldc -20
    //   11: invokestatic 157	com/google/android/gms/analytics/ae:V	(Ljava/lang/String;)V
    //   14: aload_0
    //   15: iload_1
    //   16: putfield 48	com/google/android/gms/analytics/v:yW	I
    //   19: aload_0
    //   20: monitorexit
    //   21: return
    //   22: invokestatic 169	com/google/android/gms/analytics/y:eK	()Lcom/google/android/gms/analytics/y;
    ...
    //   28: invokevirtual 178	com/google/android/gms/analytics/y:a	(Lcom/google/android/gms/analytics/y$a;)V
    //   31: aload_0
    //   32: getfield 61	com/google/android/gms/analytics/v:ze	Z
    //   35: ifne +28 -> 63
    //   38: aload_0
    //   39: getfield 52	com/google/android/gms/analytics/v:za	Z
    //   42: ifeq +21 -> 63
    //   45: aload_0
    //   46: getfield 48	com/google/android/gms/analytics/v:yW	I
    //   49: ifle +14 -> 63
    //   52: aload_0
    //   53: getfield 72	com/google/android/gms/analytics/v:mHandler	Landroid/os/Handler;
    //   56: iconst_1
    //   57: getstatic 44	com/google/android/gms/analytics/v:yT	Ljava/lang/Object;
    //   60: invokevirtual 138	android/os/Handler:removeMessages	(ILjava/lang/Object;)V
    //   63: aload_0
    //   64: iload_1
    //   65: putfield 48	com/google/android/gms/analytics/v:yW	I
    //   68: iload_1
    //   69: ifle -50 -> 19
    //   72: aload_0
    //   73: getfield 61	com/google/android/gms/analytics/v:ze	Z
    //   76: ifne -57 -> 19
    //   79: aload_0
    //   80: getfield 52	com/google/android/gms/analytics/v:za	Z
    //   83: ifeq -64 -> 19
    //   86: aload_0
    //   87: getfield 72	com/google/android/gms/analytics/v:mHandler	Landroid/os/Handler;
    //   90: aload_0
    //   91: getfield 72	com/google/android/gms/analytics/v:mHandler	Landroid/os/Handler;
    //   94: iconst_1
    //   95: getstatic 44	com/google/android/gms/analytics/v:yT	Ljava/lang/Object;
