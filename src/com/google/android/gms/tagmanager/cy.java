  ...
  extends cx
{
  ...
  private au atG = new au()
  {
    ...
    {
      a(paramAnonymousBoolean, cy.a(cy.this));
    }
  };
  private bo atH;
  ...
  private void ew()
  {
    handler = new Handler(atz.getMainLooper(), new Handler.Callback()
    {
  ...
  void a(Context paramContext, ar paramar)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 86	com/google/android/gms/tagmanager/cy:atz	Landroid/content/Context;
    //   6: astore_3
    //   7: aload_3
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   19: putfield 86	com/google/android/gms/tagmanager/cy:atz	Landroid/content/Context;
    //   22: aload_0
    //   23: getfield 130	com/google/android/gms/tagmanager/cy:atB	Lcom/google/android/gms/tagmanager/ar;
    //   26: ifnonnull -15 -> 11
    //   29: aload_0
    //   30: aload_2
    //   31: putfield 130	com/google/android/gms/tagmanager/cy:atB	Lcom/google/android/gms/tagmanager/ar;
    //   34: goto -23 -> 11
    //   37: astore_1
    //   38: aload_0
    //   39: monitorexit
  ...
  public void dispatch()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 52	com/google/android/gms/tagmanager/cy:atE	Z
    //   6: ifne +16 -> 22
    //   9: ldc -96
    //   11: invokestatic 153	com/google/android/gms/tagmanager/bh:V	(Ljava/lang/String;)V
    //   14: aload_0
    //   15: iconst_1
    //   16: putfield 50	com/google/android/gms/tagmanager/cy:atD	Z
    //   19: aload_0
    //   20: monitorexit
    //   21: return
    //   22: aload_0
