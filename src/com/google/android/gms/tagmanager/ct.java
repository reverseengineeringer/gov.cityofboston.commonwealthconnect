...
class ct
{
  ...
  {
    atm += 1;
    Object localObject = (b)ati.get(paramString);
    if ((localObject != null) && (!atd.pH()))
    {
      a(((b)localObject).qm(), paramSet);
      atm -= 1;
      return ((b)localObject).qG();
    }
    localObject = (c)atk.get(paramString);
    if (localObject == null)
    {
    ...
    bz localbz = a(paramString, ((c)localObject).qH(), ((c)localObject).qI(), ((c)localObject).qJ(), ((c)localObject).qL(), ((c)localObject).qK(), paramSet, parambk.py());
    if (((Set)localbz.getObject()).isEmpty()) {}
    for (localObject = ((c)localObject).qM(); localObject == null; localObject = (cr.a)((Set)localbz.getObject()).iterator().next())
    {
      atm -= 1;
      return atb;
    ...
    for (parambk = atb;; parambk = new bz(parambk.getObject(), bool))
    {
      ...
      if (parambk.pX()) {
        ati.e(paramString, new b(parambk, (d.a)localObject));
      }
    ...
    a(paramSet, paramSet1, new a()
    {
      public void a(cr.e paramAnonymouse, Set<cr.a> paramAnonymousSet1, Set<cr.a> paramAnonymousSet2, cn paramAnonymouscn)
      {
        ...
        if (paramAnonymousSet1 != null)
        {
          ...
          paramAnonymouscn.pS().c(paramAnonymousSet1, paramAnonymouse);
        }
      }
    }, paramcs);
  }
