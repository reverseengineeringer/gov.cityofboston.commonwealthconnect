  ...
  implements DataLayer.c
{
  ...
  v(Context paramContext, ld paramld, String paramString, int paramInt, Executor paramExecutor)
  {
    ...
    ard = paramInt;
    arb = paramExecutor;
    arc = new a(mContext, paramString);
  }
  ...
  private void b(List<b> paramList, long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 78	com/google/android/gms/tagmanager/v:wb	Lcom/google/android/gms/internal/ld;
    ...
    //   26: invokespecial 135	com/google/android/gms/tagmanager/v:fI	(I)V
    //   29: aload_0
    //   30: aload_1
    //   31: lload 4
    //   33: lload_2
    ...
    //   38: aload_0
    //   39: invokespecial 141	com/google/android/gms/tagmanager/v:pC	()V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: astore_1
    //   46: aload_0
    //   47: invokespecial 141	com/google/android/gms/tagmanager/v:pC	()V
    //   50: aload_1
    //   51: athrow
    //   52: astore_1
    //   53: aload_0
  ...
  private List<String> fJ(int paramInt)
  {
    ...
    //   155: aload 4
    //   157: astore_3
    //   158: new 199	java/lang/StringBuilder
    //   161: dup
    //   162: invokespecial 200	java/lang/StringBuilder:<init>	()V
    //   165: ldc_w 299
    //   168: invokevirtual 204	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: aload 5
    //   173: invokevirtual 302	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   176: invokevirtual 204	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 210	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 114	com/google/android/gms/tagmanager/bh:W	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  private Object j(byte[] paramArrayOfByte)
  {
    ...
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 351	java/io/ByteArrayInputStream:<init>	([B)V
    //   8: astore_3
    //   9: new 353	java/io/ObjectInputStream
    //   12: dup
    //   13: aload_3
    //   14: invokespecial 356	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   17: astore_1
    //   18: aload_1
    //   19: invokevirtual 359	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   22: astore_2
    //   23: aload_1
    //   24: ifnull +7 -> 31
    //   27: aload_1
    //   28: invokevirtual 360	java/io/ObjectInputStream:close	()V
    //   31: aload_3
    //   32: invokevirtual 361	java/io/ByteArrayInputStream:close	()V
    //   35: aload_2
    //   36: areturn
    //   37: astore_1
    //   38: aconst_null
    ...
    //   41: ifnull +7 -> 48
    //   44: aload_1
    //   45: invokevirtual 360	java/io/ObjectInputStream:close	()V
    //   48: aload_3
    //   49: invokevirtual 361	java/io/ByteArrayInputStream:close	()V
    //   52: aconst_null
    //   53: areturn
    //   54: astore_1
    //   55: aconst_null
    ...
    //   61: ifnull +7 -> 68
    //   64: aload_1
    //   65: invokevirtual 360	java/io/ObjectInputStream:close	()V
    //   68: aload_3
    //   69: invokevirtual 361	java/io/ByteArrayInputStream:close	()V
    //   72: aconst_null
    //   73: areturn
    //   74: astore_1
    //   75: aconst_null
    ...
    //   81: ifnull +7 -> 88
    //   84: aload_1
    //   85: invokevirtual 360	java/io/ObjectInputStream:close	()V
    //   88: aload_3
    //   89: invokevirtual 361	java/io/ByteArrayInputStream:close	()V
    //   92: aload_2
    //   93: athrow
    //   94: astore_1
    //   95: goto -3 -> 92
  ...
  private List<b> j(List<DataLayer.a> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new b(KP, m(wF)));
    }
    return localArrayList;
  }
