...
public class Container
{
  ...
  private void a(cr.c paramc)
  {
    ...
    ag localag = cs(aqs);
    a(new ct(mContext, paramc, aqn, new a(null), new b(null), localag));
  }
  ...
  FunctionCallMacroCallback cp(String paramString)
  {
    synchronized (aqp)
    {
      paramString = (FunctionCallMacroCallback)aqp.get(paramString);
      return paramString;
    }
  }
  ...
  FunctionCallTagCallback cq(String paramString)
  {
    synchronized (aqq)
    {
      paramString = (FunctionCallTagCallback)aqq.get(paramString);
      return paramString;
    }
  }
    ...
    implements s.a
  {
    ...
    {
      Container.FunctionCallMacroCallback localFunctionCallMacroCallback = cp(paramString);
    ...
    implements s.a
  {
    ...
    public Object b(String paramString, Map<String, Object> paramMap)
    {
      Container.FunctionCallTagCallback localFunctionCallTagCallback = cq(paramString);
