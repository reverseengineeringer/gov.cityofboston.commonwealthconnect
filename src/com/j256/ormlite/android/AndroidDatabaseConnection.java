  ...
  implements DatabaseConnection
{
    ...
    throws java.sql.SQLException
  {
    ...
    for (;;)
    {
      ...
      try
      {
        SQLiteStatement localSQLiteStatement = db.compileStatement(paramString1);
      ...
      try
      {
        localObject1 = db.compileStatement("SELECT CHANGES()");
  ...
  {
    paramStatementType = new AndroidCompiledStatement(paramString, db, paramStatementType);
    ...
    throws java.sql.SQLException
  {
    ...
    try
    {
      paramArrayOfObject = db.rawQuery(paramString, toStrings(paramArrayOfObject));
      paramArrayOfFieldType = paramArrayOfObject;
