...
.method private static addAndCheck(II)I
    ...
    const-string/jumbo v3, "overflow: add"
...
.method private addSub(Lorg/apache/commons/lang3/math/Fraction;Z)Lorg/apache/commons/lang3/math/Fraction;
    ...
    const-string/jumbo v8, "The fraction must not be null"
    ...
    const-string/jumbo v8, "overflow: numerator too large after multiply"
...
.method public static getFraction(D)Lorg/apache/commons/lang3/math/Fraction;
    ...
    const-string/jumbo v28, "The value must not be greater than Integer.MAX_VALUE or NaN"
    ...
    const-string/jumbo v28, "Unable to convert double to fraction"
...
.method public static getFraction(III)Lorg/apache/commons/lang3/math/Fraction;
    ...
    const-string/jumbo v3, "The denominator must not be zero"
    ...
    const-string/jumbo v3, "The denominator must not be negative"
    ...
    const-string/jumbo v3, "The numerator must not be negative"
    ...
    const-string/jumbo v3, "Numerator too large to represent as an Integer."
...
.method public static getFraction(Ljava/lang/String;)Lorg/apache/commons/lang3/math/Fraction;
    ...
    const-string/jumbo v5, "The string must not be null"
    ...
    const-string/jumbo v5, "The fraction could not be parsed as the format X Y/Z"
...
.method public static getReducedFraction(II)Lorg/apache/commons/lang3/math/Fraction;
    ...
    const-string/jumbo v2, "The denominator must not be zero"
    ...
    const-string/jumbo v2, "overflow: can\'t negate"
...
.method private static greatestCommonDivisor(II)I
    ...
    const-string/jumbo v3, "overflow: gcd is 2^31"
...
.method private static mulAndCheck(II)I
    ...
    const-string/jumbo v3, "overflow: mul"
...
.method private static mulPosAndCheck(II)I
    ...
    const-string/jumbo v3, "overflow: mulPos"
...
.method public multiplyBy(Lorg/apache/commons/lang3/math/Fraction;)Lorg/apache/commons/lang3/math/Fraction;
    ...
    const-string/jumbo v3, "The fraction must not be null"
