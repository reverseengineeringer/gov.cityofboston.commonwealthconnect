...
.method private dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    .line 300
    .local v3, "presenter":Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;
    if-nez v3, :cond_3
    ...
    .line 307
    invoke-interface {v3, v2}, Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method private dispatchSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 282
    invoke-interface {v2}, Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 290
    .end local v1    # "id":I
    .end local v2    # "presenter":Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;
    .end local v4    # "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;>;"
...
.method public bindNativeOverflow(Landroid/view/Menu;Landroid/view/MenuItem$OnMenuItemClickListener;Ljava/util/HashMap;)Z
    ...
    .line 1279
    .local v7, "nonActionItems":Ljava/util/List;, "Ljava/util/List<Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;>;"
    if-eqz v7, :cond_0
    ...
    .line 1286
    .local v6, "nonActionItem":Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;
    invoke-virtual {v6}, Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;->isVisible()Z
    ...
    .line 1292
    invoke-virtual {v6}, Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;->hasSubMenu()Z
    ...
    invoke-interface {v0, v11, v12, v13, v14}, Landroid/view/Menu;->addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;

    move-result-object v4

    .line 1296
    .local v4, "nativeSub":Landroid/view/SubMenu;
    invoke-virtual {v6}, Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;->getSubMenu()Lcom/actionbarsherlock/view/SubMenu;

    move-result-object v9

    check-cast v9, Lcom/actionbarsherlock/internal/view/menu/SubMenuBuilder;

    .line 1297
    .local v9, "subMenu":Lcom/actionbarsherlock/internal/view/menu/SubMenuBuilder;
    invoke-virtual {v9}, Lcom/actionbarsherlock/internal/view/menu/SubMenuBuilder;->getVisibleItems()Ljava/util/ArrayList;
    ...
    .line 1298
    .local v8, "subItem":Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;
    ...
    invoke-interface {v4, v11, v12, v13, v14}, Landroid/view/SubMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;

    move-result-object v5

    .line 1301
    .local v5, "nativeSubItem":Landroid/view/MenuItem;
    ...
    invoke-interface {v5, v11}, Landroid/view/MenuItem;->setIntent(Landroid/content/Intent;)Landroid/view/MenuItem;
    ...
    invoke-interface {v5, v11}, Landroid/view/MenuItem;->setNumericShortcut(C)Landroid/view/MenuItem;
    ...
    invoke-interface {v5, v11}, Landroid/view/MenuItem;->setAlphabeticShortcut(C)Landroid/view/MenuItem;
    ...
    invoke-interface {v5, v11}, Landroid/view/MenuItem;->setTitleCondensed(Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v5, v11}, Landroid/view/MenuItem;->setCheckable(Z)Landroid/view/MenuItem;
    ...
    invoke-interface {v5, v11}, Landroid/view/MenuItem;->setChecked(Z)Landroid/view/MenuItem;
    ...
    invoke-interface {v4, v11, v12, v13}, Landroid/view/SubMenu;->setGroupCheckable(IZZ)V
    ...
    .line 1318
    .end local v5    # "nativeSubItem":Landroid/view/MenuItem;
    .end local v8    # "subItem":Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;
    :cond_5
    ...
    .end local v4    # "nativeSub":Landroid/view/SubMenu;
    .end local v9    # "subMenu":Lcom/actionbarsherlock/internal/view/menu/SubMenuBuilder;
    .local v3, "nativeItem":Landroid/view/MenuItem;
    :goto_2
    ...
    invoke-interface {v0, v11, v12, v13}, Landroid/view/Menu;->setGroupCheckable(IZZ)V
    ...
    .line 1320
    .end local v3    # "nativeItem":Landroid/view/MenuItem;
    :cond_7
    invoke-virtual {v6}, Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;->getGroupId()I
    ...
    invoke-interface {v0, v11, v12, v13, v14}, Landroid/view/Menu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;

    move-result-object v3

    .restart local v3    # "nativeItem":Landroid/view/MenuItem;
    goto :goto_2
.end method
...
.method final close(Z)V
    ...
    .prologue
    .line 919
    iget-boolean v3, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mIsClosing:Z
    ...
    iput-boolean v3, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mIsClosing:Z
...
.method public collapseItemActionView(Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;)Z
    ...
    iget-object v4, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mExpandedItem:Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;
    ...
    .line 1261
    :cond_4
    invoke-interface {v2, p0, p1}, Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;->collapseItemActionView(Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;)Z
    ...
    iput-object v4, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mExpandedItem:Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;
...
.method public expandItemActionView(Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;)Z
    ...
    .line 1239
    :cond_3
    invoke-interface {v2, p0, p1}, Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;->expandItemActionView(Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;)Z
...
.method public flagActionItems()V
    ...
    .prologue
    .line 1043
    iget-boolean v8, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mIsActionItemsStale:Z
    ...
    .line 1050
    .local v6, "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;>;"
    invoke-virtual {v6}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;

    .line 1051
    .local v5, "presenter":Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;
    if-nez v5, :cond_1
    ...
    .line 1058
    .end local v5    # "presenter":Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;
    .end local v6    # "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;>;"
    :cond_2
    if-eqz v0, :cond_4

    .line 1059
    iget-object v8, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;

    invoke-virtual {v8}, Ljava/util/ArrayList;->clear()V

    .line 1060
    iget-object v8, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
    ...
    .line 1062
    .local v7, "visibleItems":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;>;"
    ...
    .end local v7    # "visibleItems":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/actionbarsherlock/internal/view/menu/MenuItemImpl;>;"
    :cond_4
    iget-object v8, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
    ...
    iput-boolean v8, p0, Lcom/actionbarsherlock/internal/view/menu/MenuBuilder;->mIsActionItemsStale:Z
...
.method public removeMenuPresenter(Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;)V
    ...
    .line 233
    .local v1, "item":Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;
    if-eqz v1, :cond_1
    ...
    .line 237
    .end local v1    # "item":Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;
    .end local v2    # "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/actionbarsherlock/internal/view/menu/MenuPresenter;>;"
    :cond_2
    return-void
.end method
