...
.method static synthetic access$000(Lcom/actionbarsherlock/internal/ActionBarSherlockCompat;)Z
    .locals 1
    .param p0, "x0"    # Lcom/actionbarsherlock/internal/ActionBarSherlockCompat;
...
.method private generateLayout()Landroid/view/ViewGroup;
    ...
    const-string/jumbo v6, "You must use Theme.Sherlock, Theme.Sherlock.Light, Theme.Sherlock.Light.DarkActionBar, or a derivative."
    ...
    const-string/jumbo v6, "Couldn\'t find content container view"
...
.method private installDecor()V
    ...
    .end local v7    # "uiOptions":I
    .end local v8    # "views":Ljava/util/List;, "Ljava/util/List<Landroid/view/View;>;"
    :cond_8
    return-void

    .restart local v4    # "splitActionBar":Z
    .restart local v7    # "uiOptions":I
    .restart local v8    # "views":Ljava/util/List;, "Ljava/util/List<Landroid/view/View;>;"
    :cond_9
    move v6, v10
    ...
    sget v11, Lcom/actionbarsherlock/R$styleable;->SherlockTheme_windowSplitActionBar:I
    ...
    .line 950
    const-string/jumbo v9, "ActionBarSherlock"

    const-string/jumbo v10, "Requested split action bar with incompatible window decor! Ignoring request."
...
.method private static loadUiOptionsFromManifest(Landroid/app/Activity;)I
    ...
    .line 1072
    const-string/jumbo v13, "uiOptions"
...
.method public onMenuItemClick(Landroid/view/MenuItem;)Z
    ...
    .line 592
    :cond_0
    const-string/jumbo v1, "ActionBarSherlock"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "Options item \""
    ...
    const-string/jumbo v3, "\" not found in mapping"
