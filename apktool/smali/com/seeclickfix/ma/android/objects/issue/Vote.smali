.class public Lcom/seeclickfix/ma/android/objects/issue/Vote;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 19
    new-instance v0, Lcom/seeclickfix/ma/android/objects/issue/Vote$1;

    invoke-direct {v0}, Lcom/seeclickfix/ma/android/objects/issue/Vote$1;-><init>()V

    sput-object v0, Lcom/seeclickfix/ma/android/objects/issue/Vote;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method synthetic constructor <init>(Landroid/os/Parcel;Lcom/seeclickfix/ma/android/objects/issue/Vote$1;)V
    .locals 0
    .param p1, "x0"    # Landroid/os/Parcel;
    .param p2, "x1"    # Lcom/seeclickfix/ma/android/objects/issue/Vote$1;

    .prologue
    .line 17
    invoke-direct {p0, p1}, Lcom/seeclickfix/ma/android/objects/issue/Vote;-><init>(Landroid/os/Parcel;)V
...
.method public constructor <init>(Lcom/seeclickfix/ma/android/objects/issue/Issue;)V
    ...
    .prologue
    .line 47
    const-string/jumbo v0, "Issue Voted For"
...
.method public bridge synthetic toEvent(Lcom/seeclickfix/ma/android/api/SCFService$RetrofitResult;)Lcom/seeclickfix/ma/android/api/SCFService$IssueActionEvent;
    ...
    .prologue
    .line 16
    invoke-virtual {p0, p1}, Lcom/seeclickfix/ma/android/objects/issue/Vote;->toEvent(Lcom/seeclickfix/ma/android/api/SCFService$RetrofitResult;)Lcom/seeclickfix/ma/android/api/SCFService$VoteResultEvent;
...
.method public toEvent(Lcom/seeclickfix/ma/android/api/SCFService$RetrofitResult;)Lcom/seeclickfix/ma/android/api/SCFService$VoteResultEvent;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Lcom/seeclickfix/ma/android/api/SCFService$VoteResultEvent;

    invoke-direct {v0, p0, p1}, Lcom/seeclickfix/ma/android/api/SCFService$VoteResultEvent;-><init>(Lcom/seeclickfix/ma/android/objects/issue/Vote;Lcom/seeclickfix/ma/android/api/SCFService$RetrofitResult;)V
...
.method public updateCard(Lcom/seeclickfix/ma/android/fragments/interfaces/IssueCard;Lcom/seeclickfix/ma/android/api/SCFService$IssueActionReceipt;)V
    ...
    .line 68
    invoke-interface {p1, p0, p2}, Lcom/seeclickfix/ma/android/fragments/interfaces/IssueCard;->recordVote(Lcom/seeclickfix/ma/android/objects/issue/Vote;Lcom/seeclickfix/ma/android/api/SCFService$IssueActionReceipt;)V
