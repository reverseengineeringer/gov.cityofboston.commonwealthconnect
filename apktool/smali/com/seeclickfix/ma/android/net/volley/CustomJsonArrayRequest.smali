.class public Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;
.super Lcom/android/volley/Request;
.source "CustomJsonArrayRequest.java"
...
.method public constructor <init>(ILjava/lang/String;Ljava/util/Map;Lcom/android/volley/Response$Listener;Lcom/android/volley/Response$ErrorListener;)V
    ...
    .local p4, "responseListener":Lcom/android/volley/Response$Listener;, "Lcom/android/volley/Response$Listener<Lorg/json/JSONArray;>;"
    ...
    iput-object v0, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->mPriority:Lcom/android/volley/Request$Priority;

    .line 39
    iput-object p4, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->listener:Lcom/android/volley/Response$Listener;

    .line 40
    iput-object p3, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->params:Ljava/util/Map;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Map;Lcom/android/volley/Response$Listener;Lcom/android/volley/Response$ErrorListener;Landroid/content/Context;)V
    ...
    .local p3, "responseListener":Lcom/android/volley/Response$Listener;, "Lcom/android/volley/Response$Listener<Lorg/json/JSONArray;>;"
    const/4 v0, 0x0
    ...
    .line 31
    iput-object p3, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->listener:Lcom/android/volley/Response$Listener;

    .line 32
    iput-object p2, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->params:Ljava/util/Map;

    .line 33
    iput-object p5, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->c:Landroid/content/Context;
...
.method protected bridge synthetic deliverResponse(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->deliverResponse(Lorg/json/JSONArray;)V

    return-void
.end method

.method protected deliverResponse(Lorg/json/JSONArray;)V
    .locals 1
    .param p1, "response"    # Lorg/json/JSONArray;

    .prologue
    .line 64
    iget-object v0, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->listener:Lcom/android/volley/Response$Listener;
...
.method public getHeaders()Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->c:Landroid/content/Context;
...
.method protected getParams()Ljava/util/Map;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->params:Ljava/util/Map;
...
.method public getPriority()Lcom/android/volley/Request$Priority;
    ...
    .prologue
    .line 72
    iget-object v0, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->mPriority:Lcom/android/volley/Request$Priority;
...
.method public setPriority(Lcom/android/volley/Request$Priority;)V
    ...
    .prologue
    .line 76
    iput-object p1, p0, Lcom/seeclickfix/ma/android/net/volley/CustomJsonArrayRequest;->mPriority:Lcom/android/volley/Request$Priority;
