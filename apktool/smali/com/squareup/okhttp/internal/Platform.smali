...
.method private static findPlatform()Lcom/squareup/okhttp/internal/Platform;
    ...
    :try_start_3
    const-string/jumbo v2, "setNpnProtocols"
    ...
    .line 151
    const-string/jumbo v2, "getNpnSelectedProtocol"
    ...
    :goto_4
    :try_start_5
    const-string/jumbo v15, "org.eclipse.jetty.alpn.ALPN"
    :try_end_5
    ...
    :try_start_8
    const-string/jumbo v15, "org.eclipse.jetty.npn.NextProtoNego"
