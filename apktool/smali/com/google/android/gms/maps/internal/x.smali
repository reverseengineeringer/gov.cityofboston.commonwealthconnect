.class public Lcom/google/android/gms/maps/internal/x;
.super Ljava/lang/Object;


# static fields
.field private static alI:Landroid/content/Context;

.field private static alJ:Lcom/google/android/gms/maps/internal/c;
...
.method public static S(Landroid/content/Context;)Lcom/google/android/gms/maps/internal/c;
    ...
    sget-object v0, Lcom/google/android/gms/maps/internal/x;->alJ:Lcom/google/android/gms/maps/internal/c;
    ...
    :cond_0
    invoke-static {p0}, Lcom/google/android/gms/maps/internal/x;->T(Landroid/content/Context;)V

    invoke-static {p0}, Lcom/google/android/gms/maps/internal/x;->U(Landroid/content/Context;)Lcom/google/android/gms/maps/internal/c;

    move-result-object v0

    sput-object v0, Lcom/google/android/gms/maps/internal/x;->alJ:Lcom/google/android/gms/maps/internal/c;

    :try_start_0
    sget-object v0, Lcom/google/android/gms/maps/internal/x;->alJ:Lcom/google/android/gms/maps/internal/c;

    invoke-static {p0}, Lcom/google/android/gms/maps/internal/x;->getRemoteContext(Landroid/content/Context;)Landroid/content/Context;
...
.method private static U(Landroid/content/Context;)Lcom/google/android/gms/maps/internal/c;
    ...
    invoke-static {}, Lcom/google/android/gms/maps/internal/x;->nY()Z

    move-result v0

    if-eqz v0, :cond_0

    const-class v0, Lcom/google/android/gms/maps/internal/x;
    ...
    invoke-static {}, Lcom/google/android/gms/maps/internal/x;->nZ()Ljava/lang/Class;

    move-result-object v0

    invoke-static {v0}, Lcom/google/android/gms/maps/internal/x;->c(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/maps/internal/x;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/os/IBinder;

    invoke-static {v0}, Lcom/google/android/gms/maps/internal/c$a;->aS(Landroid/os/IBinder;)Lcom/google/android/gms/maps/internal/c;
...
.method private static getRemoteContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    .prologue
    sget-object v0, Lcom/google/android/gms/maps/internal/x;->alI:Landroid/content/Context;
    ...
    sput-object v0, Lcom/google/android/gms/maps/internal/x;->alI:Landroid/content/Context;
...
.method private static nZ()Ljava/lang/Class;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
