...
.method constructor <init>(Lcom/google/common/util/concurrent/Service$State;ZLjava/lang/Throwable;)V
    ...
    :goto_0
    const-string/jumbo v3, "shudownWhenStartupFinishes can only be set if state is STARTING. Got %s instead."
    ...
    :goto_3
    const-string/jumbo v3, "A failure cause should be set if and only if the state is failed.  Got %s and %s instead."
...
.method failureCause()Ljava/lang/Throwable;
    ...
    :goto_0
    const-string/jumbo v3, "failureCause() is only valid if the service has failed, service is %s"
