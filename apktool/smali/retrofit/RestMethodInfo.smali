...
.method private parseMethodAnnotations()V
    ...
    .line 139
    const-string/jumbo v7, "Only one HTTP method is allowed. Found: %s and %s."
    ...
    const-string/jumbo v7, "Failed to extract String \'value\' from @%s annotation."
    ...
    .line 155
    const-string/jumbo v7, "@Headers annotation is empty."
    ...
    .line 160
    const-string/jumbo v7, "Only one encoding annotation is allowed."
    ...
    .line 170
    const-string/jumbo v7, "Only methods having %s as data type are allowed to have @%s annotation."
    ...
    .line 179
    const-string/jumbo v7, "HTTP method annotation is required (e.g., @GET, @POST, etc.)."
    ...
    .line 183
    const-string/jumbo v7, "Multipart can only be specified on HTTP methods with request body (e.g., @POST)."
    ...
    .line 187
    const-string/jumbo v7, "FormUrlEncoded can only be specified on HTTP methods with request body (e.g., @POST)."
...
.method private parseParameters()V
    ...
    .line 401
    const-string/jumbo v14, "Multiple Retrofit annotations found, only one allowed: @%s, @%s."
    ...
    .line 344
    const-string/jumbo v14, "@QueryMap parameter type must be Map."
    ...
    .line 349
    const-string/jumbo v14, "@EncodedQueryMap parameter type must be Map."
    ...
    .line 356
    const-string/jumbo v14, "@Field parameters can only be used with form encoding."
    ...
    .line 362
    const-string/jumbo v14, "@FieldMap parameters can only be used with form encoding."
    ...
    .line 365
    const-string/jumbo v14, "@FieldMap parameter type must be Map."
    ...
    .line 371
    const-string/jumbo v14, "@Part parameters can only be used with multipart encoding."
    ...
    .line 377
    const-string/jumbo v14, "@PartMap parameters can only be used with multipart encoding."
    ...
    .line 381
    const-string/jumbo v14, "@PartMap parameter type must be Map."
    ...
    .line 387
    const-string/jumbo v14, "@Body parameters cannot be used with form or multi-part encoding."
    ...
    .line 391
    const-string/jumbo v14, "Multiple @Body method annotations found."
    ...
    .line 411
    const-string/jumbo v14, "No Retrofit annotation found."
    ...
    .line 416
    const-string/jumbo v14, "Non-body HTTP method cannot contain @Body or @TypedOutput."
    ...
    .line 419
    const-string/jumbo v14, "Form-encoded method must contain at least one @Field."
    ...
    .line 422
    const-string/jumbo v14, "Multipart method must contain at least one @Part."
...
.method private parsePath(Ljava/lang/String;)V
    ...
    .line 196
    :cond_0
    const-string/jumbo v5, "URL path \"%s\" must start with \'/\'."
    ...
    .line 210
    const-string/jumbo v5, "URL query string \"%s\" must not have replace block. For dynamic query parameters use @Query."
...
.method private parseResponseType()Lretrofit/RestMethodInfo$ResponseType;
    ...
    .line 267
    const-string/jumbo v9, "Must have return type or Callback as last argument, not both."
    ...
    .line 270
    const-string/jumbo v9, "Must have either a return type or Callback as last argument."
    ...
    .line 292
    :cond_8
    const-string/jumbo v9, "Last parameter must be of type Callback<X> or Callback<? super X>."
...
.method parseHeaders([Ljava/lang/String;)Ljava/util/List;
    ...
    .line 227
    :cond_0
    const-string/jumbo v5, "@Headers value must be in the form \"Name: Value\". Found: \"%s\""
